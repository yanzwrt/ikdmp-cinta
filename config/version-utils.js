...
function getVersionInfo() {
    ...
    return {
        ...
        companyHeader: settings.company_header || 'IKDMP-CINTA',
        footerInfo: settings.footer_info || 'Info Hubungi : 082130077713',
